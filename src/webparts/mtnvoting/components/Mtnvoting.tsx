...
import { AdminApproved, AdminDashboard, AdminDeclined, AdminPending, AdminViewApproved, AdminViewPending, CandidateDashboard, CandidateEdit, candidateRegister, ErrorScreen, ViewRequest } from './screens';
import "./global.scss"
